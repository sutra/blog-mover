...
<div id="header">
	<ul class="menuList">
		<li id="menu_step1">
			<a title="Step 1: 选择源 Blog" onclick="return selectTab('step1')"
				accesskey="S"> <span class="accesskey">S</span>tep 1: 选择源 Blog
			</a>
		</li>
		<li id="menu_step2">
			<a title="Step 2: 选择目标 Blog" onclick="return selectTab('step2')"
				accesskey="T"> S<span class="accesskey">t</span>ep 2: 选择目标 Blog </a>
		</li>
		<li id="menu_step3">
			<a title="Step 3: 去除不需要导入的日志" onclick="return selectTab('step3')"
				accesskey="E"> St<span class="accesskey">e</span>p 3: 去除不需要导入的日志
			</a>
		</li>
		<li id="menu_option">
