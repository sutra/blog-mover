...
public class ModifyEntryHtmlParserTest extends TestCase {
	...
	public void testParse() throws IOException, SAXException {
		...
		testParse("blue_log_ct_2.html", "UTF-8",
				"测试", "测试日志内容。", date, tags); // blue_log_ct.asp_action_edit_id_52108763.html
	}
	...
	public void testParse2() throws IOException, SAXException {
		...
		testParse(
				"blue_log_ct_1.html", // blue_log_ct_html.asp.title_id_is_title_not_mytitle.html
				"UTF-8",
				"旅游归来",
