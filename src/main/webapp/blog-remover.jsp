...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="zh-CN">
	<head>
		<title>Blog Remover （博客“搬家公司”、博客通用搬家工具、博客搬家服务）</title>
		<meta http-equiv="Content-Type"
			content="application/xhtml-xml; charset=UTF-8" />
		<meta name="robots" content="all" />
		<meta name="keywords"
			content="blog, weblog, 博客, remover, 搬家, 博客搬家, 博客通用搬家工具, 博客搬家服务, 博客搬家软件" />
		<meta name="description"
			content="Blog Remover （博客通用搬家工具）可以帮你的博客搬家，可以在任意 BSP 之前自由地搬迁。" />
