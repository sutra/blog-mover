...
import com.redv.blogmover.bsps.com.blogchinese.LoginResponseParser;
...
public class BlogCupLogin {
	private static final String loginActionUrl = "http://www.blogcup.com/login.asp";
	...
	/**
	 * Try to login to the http://www.blogcup.com/.
	 * 
	 * @param username
	 * @param password
